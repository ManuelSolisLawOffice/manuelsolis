...
import {
  ...
  Star,
  Gavel, // Usado en el proceso
  Globe, // Icono no usado en la data, pero disponible
} from 'lucide-react';
...
// =========================================================================
// --- DATOS DE RECLAMACIONES DE SEGUROS (Data Original con Traducciones revisadas) ---
// =========================================================================
const texts = {
  mainCases: [
    {
      ...
      icon: Zap,
      position: "col-span-3 lg:col-span-2 h-[450px]", // Ancho
      content: {
    ...
    },
    {
      ...
      icon: Scale, 
      position: "col-span-3 lg:col-span-3 h-[450px]", // Ancho total
      content: {
...
export default function InsuranceClaimsPage() {
  ...
  // Mapeo para el layout del Grid (2 columnas para Incendio y Disputas, 1 para el resto)
  const responsiveCases = mainCasesData.map((item, index) => {
    if (index === 0) return { ...item, position: "col-span-3 lg:col-span-2 h-[450px]" }; // Incendio (Ancho)
    if (index === 4) return { ...item, position: "col-span-3 lg:col-span-3 h-[450px]" }; // Disputas (Ancho total)
    return { ...item, position: "col-span-3 lg:col-span-1 h-[450px]" }; // Granizo, Tornado, Tuberías (Normal)
  });
        ...
        <div className="container mx-auto max-w-7xl">
           <div className="grid lg:grid-cols-12 gap-12 items-center">
             ...
             >
                ...
                {/* Imagen del Abogado/Hero (Placeholder para Seguros) */}
                <div className="relative z-10 w-full h-full">
                   <Image
                     src="/insurance-hero.png" // PLACEHOLDER TEMPORAL PARA SEGUROS
                ...
                >
                   <div className="flex items-baseline text-transparent bg-clip-text bg-gradient-to-b from-white via-white to-sky-200/50">
                      <span className="text-5xl font-bold tracking-tighter">8K</span> 
              ...
              <div className="w-full lg:w-3/5 p-8 md:p-12 overflow-y-auto bg-[#001540] text-white">
                    ...
                    >
                      <div className="bg-white/5 p-6 md:p-8 rounded-2xl border border-white/10 shadow-sm">
                        <h5 className="font-black text-white mb-5 flex items-center gap-3 text-xl">
                          ...
                          >
                            {/* Usamos un icono genérico del modal para los subtítulos */}
                ...
                >
                  <motion.a 
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="group w-full py-4 bg-[#B2904D] text-[#001540] rounded-xl font-black flex items-center justify-center gap-3 shadow-lg hover:bg-white transition-all"
                  >
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          ...
          >
             <div className="text-white"> 
               {/* Título de la sección de contacto (Usando t() y manteniendo limpio) */}
